...
export const INPUT_INVESTED_VALUE = "#valorInvestido";
...
export const LABEL_DAYS_BETWEEN_INVESTMENT_WITHDRAW =
  "Dias corridos entre a data do investimento e a data do resgate";
